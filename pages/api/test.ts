...
//     let messages = until.elementLocated(
//       By.xpath(
//         "//*[contains(text(), 'Passwords do not match - Please try again.')]"
//       )
//     );
//     if (messages) {
...
//     await driver.findElement(By.css('button[type="submit"]')).click();
//     let messages = until.elementLocated(
//       By.xpath("//*[contains(text(), 'Account registered successfully.')]")
//     );
//     if (messages) {
//       console.log("Test case passed: Correct error message displayed.");
//     } else {
...
//     let messages = until.elementLocated(
//       By.xpath(
//         "//*[contains(text(), 'Email already exists - Please try again.')]"
//       )
//     );
//     if (messages) {
//       console.log("Test case passed: Correct error message displayed.");
...
//     let messages = until.elementLocated(
//       By.xpath(
//         "//*[contains(text(), 'Login failed - Please check your email and password.')]"
//       )
//     );
//     if (messages) {
//       console.log("Test case passed: Correct error message displayed.");
