...
const Profile = () => {
  return (
    <div>
      <div className="flex justify-center items-center cd">
      ...
      <div className="ml-10 0">
        ...
        <div className="ml-10">
          <div className="flex gap-10 mt-2">
            <p className="font-extralight text-black opacity-100">Họ tên</p>
            <p className="ml-24">Cao Ngô Gia Phú</p>
          </div>

          <div className="flex gap-10 mt-4">
            <p className="font-extralight text-black opacity-100">Điện Thoại</p>
            <p className="ml-20">0333924997</p>
          </div>
          <div className="flex gap-10 mt-4">
            <p className="font-extralight text-black opacity-100">Email</p>
            <p className="ml-[118px]">caongogiaphu@gmail.com</p>
          </div>
        </div>
      </div>
